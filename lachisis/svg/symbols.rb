  ...
  class SVG
    ...
    class Symbols
      ...
      def arrive(endX, y, character)
        ...
        %{<path id="symbol_appear_#{character}_#{x}_#{y}" class="symbol symbol_#{character} symbol-appear" fill="none" stroke="black" stroke_width="#{Constants::THREAD_WIDTH}" d="#{path.join(' ')}"/>}
      end
